...
PyObject *
_wrap_pygolib_Power(PyObject * PYBINDGEN_UNUSED(dummy), PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    long long retval;
    long long a;
...
PyObject * _wrap_pygolib_Power(PyObject * PYBINDGEN_UNUSED(dummy), PyObject *args, PyObject *kwargs);

static PyMethodDef pygolib_functions[] = {
    {(char *) "Power", (PyCFunction) _wrap_pygolib_Power, METH_KEYWORDS|METH_VARARGS, "Power(a, b)\n\ntype: a: long long\ntype: b: long long" },
    {NULL, NULL, 0, NULL}
};
#if PY_VERSION_HEX >= 0x03000000
